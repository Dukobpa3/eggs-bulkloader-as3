package gd.eggs.loading.loadingtypes {
    ...
    import gd.eggs.loading.utils.SmartURL;
     ...
     */
    [Event(name="canBeginPlaying", type="gd.eggs.loading.BulkProgressEvent")]
     ...
     */ public class LoadingItem extends EventDispatcher {
        ...
        /** @private */
        public var _byteContent:ByteArray;
        ...
        /**
         * Утилитна�? переменна�? нужна в �?лушател�?х чтобы повторно не кодировать байт�?ррей
         */
        protected var _fromSO:Boolean = false;
        ...
        public function _parseOptions(props:Object):Array {
            _context = props[BulkLoader.CONTEXT];
            ...
            _shared = props[BulkLoader.SHARED] || false;
