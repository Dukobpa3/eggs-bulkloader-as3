package gd.eggs.loading.utils.display
{
	...
	public class Loader extends Sprite
	{
		 ...
		 *                            specifications.
		 * @param context           <LoaderContext/> A LoaderContext object, which has properties that define the following:
		 ...
		 * @param context           <LoaderContext/> A LoaderContext object. Only the applicationDomain property
