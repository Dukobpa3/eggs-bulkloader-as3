package gd.eggs.loading {
    ...
    import gd.eggs.loading.loadingtypes.*;
     ...
     */
    [Event(name="progress", type="gd.eggs.loading.BulkProgressEvent")]
     ...
     *  @eventType br.com.stimuli.loading.BulkProgressEvent
     */
    [Event(name="complete", type="gd.eggs.loading.BulkProgressEvent")]
    ...
    public class BulkLoader extends EventDispatcher {
        ...
        public static const GENERAL_AVAILABLE_PROPS:Array = [ WEIGHT, MAX_TRIES, HEADERS, ID, PRIORITY, PREVENT_CACHING, "type", SHARED];
        ...
        public static const DEFAULT_NUM_CONNECTIONS:int = 1;

        /**
         * App_name for SharedObject
         */
        public static const APP_NAME:String = "AddictedCompanyGame";

        /**
         * Link to SharedObject
         */
        ...
        /**
         * enable/disable storing to SharedObject for this loader
         */
        public var _storeToSO:Boolean = false;
         ...
         *   @param  storeToSharedObject Enables storing to SO.
         *   @param  logLevel At which level should traces be outputed. By default only errors will be traced.
         *
         *   @see #numConnections
         *   @see #log()
         */
        public function BulkLoader(name:String = null, numConnections:int = BulkLoader.DEFAULT_NUM_CONNECTIONS/*, storeToSharedObject:Boolean = false*/, logLevel:int = BulkLoader.DEFAULT_LOG_LEVEL) {
            if (!name) {
                name = getUniqueName();
            }
            ...
            /*if (sharedObject.data.hasOwnProperty("contents"))
             {
             this._contents = sharedObject.data.contents;
             }*/
        ...
        public function add(url:*, props:Object = null):LoadingItem {
            ...
            if (!props.hasOwnProperty("id") && _allowsAutoIDFromFileName) {
        ...
        public function _onItemComplete(evt:Event):void {
            ...
            if (item.shared) {
                ...
                if (!sharedObject.data.contents.hasOwnProperty(item.url.url) || !sharedObject.data.contents[item.url.url]) {
                    sharedObject.data.contents[item.url.url] = item._byteContent;
                    sharedObject.flush();
                    //item._byteContent.clear();
